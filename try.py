...
- “I adore Pride and Prejudice.” -> book talk

Recommendation Examples:
- “Can you recommend a book like One Piece?” -> recommendation
- “Suggest something similar to The Hunger Games.” -> recommendation
...
def respond(message, chat_history):
    try:
        # Use only the user's message; do not prepend a system prompt.
        final_prompt = message
        result = chain.invoke({"query": final_prompt})
        ...
        # Return a single dictionary for the assistant's message
...
# Build the Gradio UI
with gr.Blocks(title="BookStop Library Assistant 📚") as demo:
    ...
    chatbot = gr.ChatInterface(
        ...
        examples=[
            ...
            "Tell me about Ryan Holiday's books",
        ],
