...
def load_knowledge_base(csv_path=file_path):
    # Load CSV file
...
def book_rent_task(query, llm, embeddings):
    pass
...
# Book Rent Runnables
book_rent_runnable = RunnableLambda(lambda x: book_rent_task(x, llm, embeddings))
...
book_task_branch = RunnableBranch(
    ...
    (lambda x: "rent" in x["book_task"] , 
     book_params_extractor | book_rent_runnable), 
